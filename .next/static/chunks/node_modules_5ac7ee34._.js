...
var Subscriber_1 = (()=>{
    const e = new Error("Cannot find module '../Subscriber'");
...
var toSubscriber_1 = (()=>{
    const e = new Error("Cannot find module './util/toSubscriber'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
"[project]/node_modules/groq/lib/groq.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/next-sanity/dist/next-sanity.esm.js [app-client] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
function createClient(config) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$lib$2f$sanityClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(config);
}
...
function useCurrentUser(projectId) {
    var _useState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(), data = _useState[0], setUser = _useState[1];
...
function createPreviewSubscriptionHook(_ref) {
    ...
    function getStore(abort) {
        if (!store) {
            store = __turbopack_context__.r("[project]/node_modules/@sanity/groq-store/dist/browser/groq-store.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then(function(_ref2) {
...
function useQuerySubscription(options) {
    ...
    var _useState2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false), loading = _useState2[0], setLoading = _useState2[1];
    var _useState3 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(), data = _useState3[0], setData = _useState3[1];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useQuerySubscription.useEffect": function() {
            if (!enabled) {
                return;
            }
            setLoading(true);
            var aborter = getAborter();
            var subscription;
            getCurrentUser(projectId, aborter, token).then({
                "useQuerySubscription.useEffect": function(user) {
                    if (user) {
                        return;
                    }
                    // eslint-disable-next-line no-console
            ...
            }["useQuerySubscription.useEffect"]).then({
                "useQuerySubscription.useEffect": function() {
                    return getStore(aborter);
                }
            }["useQuerySubscription.useEffect"]).then({
                "useQuerySubscription.useEffect": function(store) {
                    subscription = store.subscribe(query, params, {
                        "useQuerySubscription.useEffect": function(err, result) {
                            if (err) {
                                setError(err);
                            } else {
                                setData(result);
            ...
            }["useQuerySubscription.useEffect"]).catch({
                "useQuerySubscription.useEffect": function(err) {
                    return err.name === 'AbortError' ? null : setError(err);
                }
            }["useQuerySubscription.useEffect"]).finally({
                "useQuerySubscription.useEffect": function() {
...
function useParams(params) {
    var stringifiedParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useParams.useMemo[stringifiedParams]": function() {
            return JSON.stringify(params);
        }
    }["useParams.useMemo[stringifiedParams]"], [
        params
    ]);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useParams.useMemo": function() {
...
//# sourceMappingURL=node_modules_5ac7ee34._.js.map