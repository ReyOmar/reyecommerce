(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_@sanity_9cc94d._.js", {
...
"[project]/node_modules/@sanity/presentation/dist/_chunks-es/LiveQueries.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function LoaderQueries(props) {
    ...
    const [syncTagsInUse] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "LoaderQueries.useState": ()=>/* @__PURE__ */ new Set()
    }["LoaderQueries.useState"]), [lastLiveEventId, setLastLiveEventId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null), studioClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useClient"])({
    ...
    const handleSyncTags = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$use$2d$effect$2d$event$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffectEvent"])({
        "LoaderQueries.useEffectEvent[handleSyncTags]": (event)=>{
            const flattenedSyncTags = Array.from(syncTagsInUse).flat();
            event.tags.some({
                "LoaderQueries.useEffectEvent[handleSyncTags]": (tag)=>flattenedSyncTags.includes(tag)
            }["LoaderQueries.useEffectEvent[handleSyncTags]"]) ? setLastLiveEventId(event.id) : console.log("No matching tags found", event.tags, {
                flattenedSyncTags
            });
        }
    }["LoaderQueries.useEffectEvent[handleSyncTags]"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoaderQueries.useEffect": ()=>{
            const subscription = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$index$2e$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(client.config()).withConfig({
                ...
                next: {
                    "LoaderQueries.useEffect.subscription": (event_0)=>{
                ...
                }["LoaderQueries.useEffect.subscription"],
                // eslint-disable-next-line no-console
                error: {
                    "LoaderQueries.useEffect.subscription": (err)=>console.error("Error validating EventSource URL:", err)
                }["LoaderQueries.useEffect.subscription"]
            });
            return ({
                "LoaderQueries.useEffect": ()=>subscription.unsubscribe()
            })["LoaderQueries.useEffect"];
        }
    }["LoaderQueries.useEffect"], [
        client,
    ...
    const liveDocument = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeferredValue"])(_liveDocument);
    return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: Object.entries(liveQueries).map(([key_0, { query, params, perspective }])=>/* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(QuerySubscription, {
...
function useQuerySubscription(props) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$presentation$2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(25), { liveDocument, client, query, params, perspective, lastLiveEventId } = props, [snapshot, setSnapshot] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null), [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    if (error) throw error;
    let t0;
    $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = {
        refreshInterval: 0
    }, $[0] = t0) : t0 = $[0];
    const [revalidate, startRefresh] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$presentation$2f$dist$2f$_chunks$2d$es$2f$hooks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRevalidate"])(t0), shouldRefetch = revalidate === "refresh" || revalidate === "inflight" || lastLiveEventId !== snapshot?.lastLiveEventId;
    let t1, t2;
    $[1] !== client || $[2] !== lastLiveEventId || $[3] !== params || $[4] !== perspective || $[5] !== query || $[6] !== shouldRefetch || $[7] !== startRefresh ? (t1 = ()=>{
        ...
        const controller = new AbortController(), effect = async function() {
            ...
            fetching = !1, signal.aborted || (setSnapshot((prev)=>({
                    result: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fast$2d$deep$2d$equal$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(prev?.result, result) ? prev?.result : result,
                    resultSourceMap: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fast$2d$deep$2d$equal$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(prev?.resultSourceMap, resultSourceMap) ? prev?.resultSourceMap : resultSourceMap,
                    syncTags: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fast$2d$deep$2d$equal$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(prev?.syncTags, syncTags) ? prev?.syncTags : syncTags,
                    lastLiveEventId
                })), fulfilled = !0);
        ...
        shouldRefetch,
        startRefresh
    ], $[1] = client, $[2] = lastLiveEventId, $[3] = params, $[4] = perspective, $[5] = query, $[6] = shouldRefetch, $[7] = startRefresh, $[8] = t1, $[9] = t2) : (t1 = $[8], t2 = $[9]), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(t1, t2);
    let t3;
...
//# sourceMappingURL=node_modules_%40sanity_9cc94d._.js.map