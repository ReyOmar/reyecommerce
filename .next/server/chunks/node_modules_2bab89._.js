...
"[project]/node_modules/@sanity/preview-url-secret/dist/constants.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const schemaType = "sanity.previewUrlSecret", schemaIdPrefix = "sanity-preview-url-secret", schemaIdSingleton = `${schemaIdPrefix}.share-access`, schemaTypeSingleton = "sanity.previewUrlShareAccess", apiVersion = "2023-11-09", urlSearchParamPreviewSecret = "sanity-preview-secret", urlSearchParamPreviewPathname = "sanity-preview-pathname", urlSearchParamPreviewPerspective = "sanity-preview-perspective", isDev = ("TURBOPACK compile-time value", "development") === "development", SECRET_TTL = 60 * 60, fetchSecretQuery = /* groq */ `*[_type == "${schemaType}" && secret == $secret && dateTime(_updatedAt) > dateTime(now()) - ${SECRET_TTL}][0]{
  ...
  secret,
  studioUrl,
}`, deleteExpiredSecretsQuery = /* groq */ `*[_type == "${schemaType}" && dateTime(_updatedAt) <= dateTime(now()) - ${SECRET_TTL}]`, tag = "sanity.preview-url-secret", perspectiveCookieName = "sanity-preview-perspective";
;
 //# sourceMappingURL=constants.js.map
}}),
"[project]/node_modules/@sanity/preview-url-secret/dist/index.js [app-route] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$preview$2d$url$2d$secret$2f$dist$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@sanity/preview-url-secret/dist/constants.js [app-route] (ecmascript)");
;
function createClientWithConfig(client) {
    if (!client) throw new TypeError("`client` is required");
    if (!client.config().token) throw new TypeError("`client` must have a `token` specified");
    return client.withConfig({
        perspective: "raw",
        // Userland might be using an API version that's too old to use perspectives
        apiVersion: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$preview$2d$url$2d$secret$2f$dist$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiVersion"],
...
function parsePreviewUrl(unsafeUrl) {
    const url = new URL(unsafeUrl, "http://localhost"), secret = url.searchParams.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$preview$2d$url$2d$secret$2f$dist$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["urlSearchParamPreviewSecret"]);
    if (!secret) throw new Error("Missing secret");
    const studioPreviewPerspective = url.searchParams.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$preview$2d$url$2d$secret$2f$dist$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["urlSearchParamPreviewPerspective"]);
    let redirectTo;
    const unsafeRedirectTo = url.searchParams.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$preview$2d$url$2d$secret$2f$dist$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["urlSearchParamPreviewPathname"]);
    if (unsafeRedirectTo) {
...
async function validateSecret(client, secret, disableCacheNoStore) {
    ...
    const { private: privateSecret, public: publicSecret } = await client.fetch(`{
      "private": ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$preview$2d$url$2d$secret$2f$dist$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchSecretQuery"]},
      "public": ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$preview$2d$url$2d$secret$2f$dist$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchSharedAccessSecretQuery"]}
    }`, {
        secret
    }, {
        tag: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$preview$2d$url$2d$secret$2f$dist$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tag"],
        // In CloudFlare Workers we can't pass the cache header
        ...disableCacheNoStore ? void 0 : {
            cache: "no-store"
        }
    });
...
async function validatePreviewUrl(_client, previewUrl, disableCacheNoStore = globalThis.navigator?.userAgent === "Cloudflare-Workers") {
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$preview$2d$url$2d$secret$2f$dist$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isDev"] && console.error("Failed to parse preview URL", error, {
            previewUrl,
            client
        }), {
            isValid: !1
    ...
    const { isValid, studioUrl } = await validateSecret(client, parsedPreviewUrl.secret, disableCacheNoStore), redirectTo = isValid ? parsedPreviewUrl.redirectTo : void 0, studioPreviewPerspective = isValid ? parsedPreviewUrl.studioPreviewPerspective : void 0;
    let studioOrigin;
    if (isValid) try {
        studioOrigin = new URL(studioUrl).origin;
    } catch (error) {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$preview$2d$url$2d$secret$2f$dist$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isDev"] && console.error("Failed to parse studioUrl", error, {
            previewUrl,
            studioUrl
        });
    }
...
//# sourceMappingURL=node_modules_2bab89._.js.map