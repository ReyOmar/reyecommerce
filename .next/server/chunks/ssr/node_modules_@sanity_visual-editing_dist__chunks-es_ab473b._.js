...
"[project]/node_modules/@sanity/visual-editing/dist/_chunks-es/transformSanityNodeData.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
}), j = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valibot$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["object"])({
    origin: y,
    href: y,
...
function U(t) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valibot$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["is"])(w, t);
}
function $(r) {
    ...
    return U(r) ? [
        [
            "id",
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$resolveEditInfo$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPublishedId"])(o)
        ],
        [
            "type",
            i
        ...
        [
            "path",
            l(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$resolveEditInfo$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["studioPath"].fromString(s))
        ],
        [
            "base",
    ...
    const r = t.split(";").reduce((t, r)=>{
        ...
        switch(o){
            ...
            case "type":
                ...
                break;
            case "path":
                t.path = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$resolveEditInfo$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["studioPath"].toString(function(t) {
                    const e = [];
...
function x(t) {
    const e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valibot$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeParse"])(w, t);
    if (e.success) return e.output;
    const r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valibot$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeParse"])(j, t);
    if (r.success) try {
        const t = new URL(r.output.href, typeof document > "u" ? "https://example.com" : location.origin);
        return t.searchParams.size > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valibot$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parse"])(w, Object.fromEntries(t.searchParams.entries())) : r.output;
    } catch (t) {
...
;
;
const c = /_key\s*==\s*['"](.*)['"]/, p = /^\d*:\d*$/;
function d(t) {
    return "number" == typeof t || "string" == typeof t && /^\[\d+\]$/.test(t);
}
function y(t) {
    return "string" == typeof t ? c.test(t.trim()) : "object" == typeof t && "_key" in t;
}
const h = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, m = /_key\s*==\s*['"](.*)['"]/;
function l(t, n, e) {
...
function g(t) {
    return d(t) ? function(t) {
        ...
        if ("string" == typeof t && p.test(t)) return !0;
...
function b(t) {
    return t.startsWith(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$dist$2f$_chunks$2d$es$2f$transformSanityNodeData$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["D"]);
}
function w(t) {
    return b(t) ? t : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$dist$2f$_chunks$2d$es$2f$transformSanityNodeData$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["D"] + t;
}
function k(t) {
    return b(t) ? t.slice(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$dist$2f$_chunks$2d$es$2f$transformSanityNodeData$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["D"].length) : t;
}
const x = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$actors$2f$dist$2f$xstate$2d$actors$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createEmptyActor"])();
let _ = x;
const S = new Set;
function I(t) {
    return t === x;
...
function E() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSyncExternalStore"])(O, v, A);
}
function A() {
    return x;
}
...
function N(t, n) {
    ...
    if (I(n) || !e) throw new Error("The `useDocuments` hook cannot be used in this context");
    const r = w(t), o = k(t), s = n.getSnapshot().context?.documents, i = s?.[r], u = s?.[o], f = i || u;
    if (!f) throw new Error(`Document "${t}" not found`);
    const a = i.getSnapshot().context?.local || u.getSnapshot().context?.local, c = new Promise((t)=>{
        if (a) t(a);
        else {
            const n = f.on("ready", (e)=>{
                const { snapshot: r } = e;
    ...
    return {
        ...
        publishedId: o,
        get snapshot () {
            if (!a) throw new Error(`Snapshot for document "${t}" not found`);
            return a;
        }
    };
}
...
function T(t, n) {
    return (e)=>{
        const { snapshot: r } = N(t, n);
        return e ? l(r, e) : r;
    };
}
function K(t, n) {
    const { getSnapshot: e } = N(t, n);
    return e;
}
function U(t, r) {
    return async (o, s)=>{
        const i = N(t, r), { draftDoc: u, draftId: f, getSnapshot: a, publishedId: c } = i, { commit: p = !0 } = s || {}, d = await ("function" == typeof o ? o({
            draftId: f,
            publishedId: c,
            get snapshot () {
                return i.snapshot;
        ...
        u.send({
            type: "mutate",
            mutations: [
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$node_modules$2f40$sanity$2f$mutate$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createIfNotExists"])({
                    ...y,
                    _id: f
                }),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$node_modules$2f40$sanity$2f$mutate$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["patch"])(f, d)
            ]
        }), p && ("object" == typeof p && "debounce" in p ? $(()=>u.send({
                type: "submit"
            }), p.debounce)() : u.send({
            type: "submit"
        }));
...
function W() {
    const n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(7), e = E();
    let r;
    n[0] !== e ? (r = (t)=>({
            id: t,
            commit: P(t, e),
    ...
    let s;
    n[2] !== e ? (s = (t, n, r)=>{
        const { draftDoc: o } = N(t, e), { commit: s } = r || {}, i = void 0 === s || s;
        o.send({
            type: "mutate",
            mutations: n
        }), i && ("object" == typeof i && "debounce" in i ? $(()=>o.send({
                type: "submit"
            }), i.debounce)() : o.send({
            type: "submit"
        }));
...
function z(t) {
    ...
    return (function(t = 16) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$random$2d$values$2d$esm$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(n), n;
...
function C(t, n, e = "after") {
    const { path: s, key: i } = B(t), u = {
        ...l(n, t.path),
        _key: z()
    };
    return [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$node_modules$2f40$sanity$2f$mutate$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["at"])(s, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$node_modules$2f40$sanity$2f$mutate$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["insert"])(u, e, {
            _key: i
        }))
    ];
}
function F(t, n) {
    const { path: e, key: o } = B(t), i = l(n, e).findIndex((t)=>t._key === o);
    return [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$node_modules$2f40$sanity$2f$mutate$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["at"])(e, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$node_modules$2f40$sanity$2f$mutate$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["truncate"])(i, i + 1))
    ];
}
function G(t, n, e) {
    const { path: s, key: i } = B(t), u = z();
    return [
...
async function H(t, n, e) {
    ...
    const { path: i, key: u } = B(t), f = await n.getSnapshot(), a = l(f, i), c = l(f, t.path), p = a.findIndex((t)=>t._key === u);
    let d = -1, y = "before";
    if ("first" === e) {
        if (0 === p) return [];
        d = 0, y = "before";
    ...
    return [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$node_modules$2f40$sanity$2f$mutate$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["at"])(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$node_modules$2f40$sanity$2f$mutate$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["truncate"])(p, p + 1)),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$node_modules$2f40$sanity$2f$mutate$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["at"])(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$node_modules$2f40$sanity$2f$mutate$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["insert"])(c, y, d))
    ];
}
;
...
function m(e, t) {
    ...
    if (0 === u) return !1;
    const d = ((l - a) * (o - s) - (c - s) * (n - a)) / u, y = ((r - n) * (o - s) - (i - o) * (n - a)) / u;
    if (d < 0 || d > 1 || y < 0 || y > 1) return !1;
    return {
        x: n + d * (r - n),
        y: o + d * (i - o)
    };
...
function h(e, t, n) {
    ...
    if (t.some((e)=>(function(e, t) {
            ...
            return n && o;
        })(o, y(e, Math.min(e.w, e.h) / 10, "horizontal" === n ? "x" : "y")))) return null;
    let r, i;
    for (const a of t){
        const t = f(e, y(a, Math.min(a.w, a.h) / 10, "horizontal" === n ? "x" : "y"));
        if (t) {
            const e = t[0];
...
let S = !1, k = {
    ...
    x: 0,
    y: 0
}, C = typeof document > "u" ? 0 : document.documentElement.scrollHeight, I = null;
function D(e) {
    ...
    const u = n.getAttribute("data-sanity-drag-flow") || ((R = c).some((e)=>R.filter((t)=>!p(e, t)).some((t)=>e.y === t.y)) ? "horizontal" : "vertical"), y = n.getAttribute("data-sanity-drag-group"), m = !!n.getAttribute("data-sanity-drag-minimap-disable"), f = !!n.getAttribute("data-sanity-drag-prevent-default"), x = n.getAttribute("data-unstable_sanity-drag-document-height"), D = n.getAttribute("data-unstable_sanity-drag-group-height");
    var R;
    let A = null;
    ...
    }, C = x ? ~~x : document.documentElement.scrollHeight);
    const z = setInterval(()=>{
        ...
        Math.abs(e.deltaY) >= 10 && Y < 1 && !S && !H && !m && _ && (r({
            type: "overlay/dragToggleMinimapPrompt",
            display: !0
        }), H = !0), e.shiftKey && !S && !m && (window.dispatchEvent(new CustomEvent("unstable_sanity/dragApplyMinimap")), setTimeout(()=>{
            q();
        }, 50));
    }, j = (e)=>{
        ...
        r({
            ...
            x: U.x,
            y: U.y
        }), e.shiftKey && !S && !m && (window.dispatchEvent(new CustomEvent("unstable_sanity/dragApplyMinimap")), setTimeout(()=>{
            q();
        }, 50));
        ...
        r({
            ...
            T(k.y, O, C, r, l, I).then(()=>{
                S = !1;
            });
        }, 50), clearInterval(z), $(), J(), B(), s();
    }, $ = ()=>{
        window.removeEventListener("mousemove", j), window.removeEventListener("wheel", W), window.removeEventListener("mouseup", V);
    }, B = ()=>{
        window.removeEventListener("keyup", X);
    }, J = ()=>{
        window.removeEventListener("blur", F);
    };
    window.addEventListener("blur", F), window.addEventListener("keyup", X), window.addEventListener("wheel", W), window.addEventListener("mousemove", j), window.addEventListener("mouseup", V);
}
...
function j(t) {
    const n = [];
    function o(t, o) {
        const r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$dist$2f$_chunks$2d$es$2f$transformSanityNodeData$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["d"])(o);
        if (!r) return;
        const i = A(t);
        i && n.push({
            elements: {
...
function B({ handler: e, overlayElement: t, inFrame: n, optimisticActorReady: o }) {
    let r = !1;
    const i = new Map, a = new WeakMap, s = new Set, l = new WeakMap, c = new WeakMap, y = n;
    let m, p, f, g = !1, h = [];
    ...
    function E({ id: t, elements: n, handlers: o }) {
        const { element: r, measureElement: i } = n;
        w(r, o), m.unobserve(i), h = h.filter((e)=>e !== r), e({
            type: "element/deactivate",
            id: t
        });
    }
    function b(t) {
        if (n && o) for (const n of h){
            if (t === n) {
    ...
    function L({ elements: c, sanity: m }) {
        const { element: f, measureElement: w } = c, E = {
            click (t) {
                const n = t.target;
                if (f === v() && f.contains(n)) {
                    y && (t.preventDefault(), t.stopPropagation());
                    const n = a.get(f)?.sanity;
                    n && !g && e({
                        type: "element/click",
                        id: L,
                        sanity: n
            ...
            contextmenu (t) {
                if (!("path" in m && n && o && m.path.split(".").pop()?.includes("[_key=="))) return;
                const r = t.target;
                f === v() && f.contains(r) && (y && (t.preventDefault(), t.stopPropagation()), e({
            ...
            mousedown (t) {
                if (t.preventDefault(), t.currentTarget !== h.at(-1) || f.getAttribute("data-sanity-drag-disable") || !n || !o) return;
                const r = a.get(f)?.sanity;
            ...
            mouseenter () {
                document.querySelector("vercel-live-feedback") && f.closest("[data-vercel-edit-info]") || f.closest("[data-vercel-edit-target]") || (h.push(f), e({
        ...
        s.add(f), l.set(w, f), i.set(L, f), a.set(f, T), p?.observe(f), e({
            type: "element/register",
            id: L,
            element: f,
            rect: d(f),
            sanity: m,
            dragDisabled: !!f.getAttribute("data-sanity-drag-disable")
        }), r && x(T);
    }
    ...
    function k(t) {
        ...
        if (n) {
            ...
            w(t, r), m.unobserve(t), a.delete(t), s.delete(t), i.delete(o), e({
    ...
    function O(t) {
        const n = N(t.target);
        n ? "capture" === n.dataset.sanityOverlayElement && (t.preventDefault(), t.stopPropagation()) : (h = [], e({
            type: "overlay/blur"
        }));
    }
    function P() {
    ...
    function G(e) {
        const { target: t } = e;
        if (t !== window.document && R(t)) for (const e of s)t.contains(e) && C(e);
    }
    function H() {
        r || (p = new IntersectionObserver(A, {
            threshold: .3
        }), s.forEach((e)=>p.observe(e)), e({
            type: "overlay/activate"
        }), r = !0);
    }
    function _() {
        r && (p?.disconnect(), s.forEach((e)=>{
            const t = a.get(e);
            t && E(t);
        }), e({
    ...
    return window.document.fonts.ready.then(()=>{
        for (const e of s)C(e);
    }), window.addEventListener("click", O), window.addEventListener("contextmenu", O), window.addEventListener("keydown", Y), window.addEventListener("resize", P), window.addEventListener("scroll", G, {
        capture: !0,
        passive: !0
    }), m = new ResizeObserver(I), f = new MutationObserver(U), f.observe(document.body, {
        attributes: !0,
        characterData: !0,
        childList: !0,
        subtree: !0
        ...
        deactivate: _,
        destroy: function() {
            window.removeEventListener("click", O), window.removeEventListener("contextmenu", O), window.removeEventListener("keydown", Y), window.removeEventListener("resize", P), window.removeEventListener("scroll", G), f.disconnect(), m.disconnect(), s.forEach((e)=>{
                k(e);
            }), i.clear(), s.clear(), h = [], _();
        }
    };
}
const J = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(null);
;
 //# sourceMappingURL=SharedStateContext.js.map
}}),
"[project]/node_modules/@sanity/visual-editing/dist/_chunks-es/create-data-attribute.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const p = {
    ...
    const { data: t } = e;
    return t && "object" == typeof t && "domain" in t && "type" in t && "from" in t && "to" in t && ("sanity/channels" === t.domain && (t.domain = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$comlink$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DOMAIN"]), "overlays" === t.to && (t.to = "visual-editing"), "overlays" === t.from && (t.from = "visual-editing"), t.channelId = t.connectionId, delete t.connectionId, t.type = p[t.type] ?? t.type), e;
}, g = ({ context: e }, t)=>{
    const { sources: a, targetOrigin: o } = e, i = ((e)=>{
        const { channelId: t, ...a } = e, o = {
            ...a,
            connectionId: t
        };
        return o.domain === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$comlink$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DOMAIN"] && (o.domain = "sanity/channels"), "visual-editing" === o.to && (o.to = "overlays"), "visual-editing" === o.from && (o.from = "overlays"), o.type = y[o.type] ?? o.type, "channel/response" === o.type && o.responseTo && !o.data && (o.data = {
            responseTo: o.responseTo
        }), ("handshake/syn" === o.type || "handshake/syn-ack" === o.type || "handshake/ack" === o.type) && (o.data = {
            id: o.connectionId
        }), o;
    })(t.message);
    a.forEach((e)=>{
        ...
        listen: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$comlink$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createListenLogic"])(h),
...
function f(e) {
    function t(e) {
        return e ? "string" == typeof e ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$resolveEditInfo$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["studioPath"].fromString(e) : e : [];
    }
    function n(e) {
        ...
        const t = {
            ...
            type: e.type,
            id: e.id,
            path: "string" == typeof e.path ? e.path : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$resolveEditInfo$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["studioPath"].toString(e.path)
        };
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$visual$2d$editing$2f$dist$2f$_chunks$2d$es$2f$transformSanityNodeData$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(t);
    }
    const a = (a)=>n({
            ...e,
            path: [
...
//# sourceMappingURL=node_modules_%40sanity_visual-editing_dist__chunks-es_ab473b._.js.map