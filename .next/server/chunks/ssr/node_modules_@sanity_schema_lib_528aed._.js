...
const DEFAULT_OVERRIDEABLE_FIELDS = [
    ...
    extend (subTypeDef, extendMember) {
        const parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(ANY_CORE, OVERRIDABLE_FIELDS$e), subTypeDef, {
            type: ANY_CORE,
...
const OVERRIDABLE_FIELDS$d = [
    ...
    extend (subTypeDef, createMemberType) {
        const parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(ARRAY_CORE, OVERRIDABLE_FIELDS$d), subTypeDef, {
            type: ARRAY_CORE
        });
...
const OVERRIDABLE_FIELDS$c = [
    ...
    extend (subTypeDef) {
        const parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(BOOLEAN_CORE, OVERRIDABLE_FIELDS$c), subTypeDef, {
            type: BOOLEAN_CORE,
...
function buildTitle$1(type) {
    return !type.to || type.to.length === 0 ? "Cross dataset Reference" : `Cross dataset reference to ${humanize$1((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$arrify$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(type.to).map((toType)=>toType.title || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$capitalize$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(toType.type)), "or").toLowerCase()}`;
}
const CrossDatasetReferenceType = {
    ...
    extend (subTypeDef, createMemberType) {
        ...
        const parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(CROSS_DATASET_REFERENCE_CORE, OVERRIDABLE_FIELDS$b), subTypeDef, {
    ...
    extend (subTypeDef) {
        const parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(DATE_CORE, OVERRIDABLE_FIELDS$a), subTypeDef, {
            type: DATE_CORE,
            preview: primitivePreview
        });
        return subtype(parsed);
    ...
    extend (subTypeDef) {
        const parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(DATETIME_CORE, OVERRIDABLE_FIELDS$9), subTypeDef, {
            type: DATETIME_CORE,
            preview: primitivePreview
        });
        return subtype(parsed);
...
const OVERRIDABLE_FIELDS$8 = [
    ...
    extend (rawSubTypeDef, createMemberType) {
        const subTypeDef = {
            ...
            ...subTypeDef.options || {}
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(this.get(), OVERRIDABLE_FIELDS$8), subTypeDef, {
            type: this.get(),
...
const DOCUMENT_CORE = {
    ...
    extend (subTypeDef) {
        const parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(EMAIL_CORE, OVERRIDABLE_FIELDS$7), subTypeDef, {
            type: EMAIL_CORE,
            preview: primitivePreview
        });
        return subtype(parsed);
    ...
    extend (rawSubTypeDef, createMemberType) {
        const options = {
            ...
            ...rawSubTypeDef,
            fields
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(FILE_CORE, OVERRIDABLE_FIELDS$6), subTypeDef, {
            type: FILE_CORE,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$groq$2d$js$2f$dist$2f$1$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/groq-js/dist/1.mjs [app-ssr] (ecmascript)");
