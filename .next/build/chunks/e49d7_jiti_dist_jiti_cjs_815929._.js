...
"[project]/node_modules/@tailwindcss/node/node_modules/jiti/dist/jiti.cjs [postcss] (ecmascript)": (function(__turbopack_context__) {
...
(()=>{
    ...
    (()=>{
        ...
        const external_node_os_namespaceObject = __turbopack_require__("[externals]/node:os [external] (node:os, cjs)");
        ...
        const external_node_module_namespaceObject = __turbopack_require__("[externals]/node:module [external] (node:module, cjs)"), external_node_fs_namespaceObject = __turbopack_require__("[externals]/node:fs [external] (node:fs, cjs)");
        ...
        }, external_node_url_namespaceObject = __turbopack_require__("[externals]/node:url [external] (node:url, cjs)"), external_node_assert_namespaceObject = __turbopack_require__("[externals]/node:assert [external] (node:assert, cjs)"), external_node_process_namespaceObject = __turbopack_require__("[externals]/node:process [external] (node:process, cjs)"), external_node_path_namespaceObject = __turbopack_require__("[externals]/node:path [external] (node:path, cjs)"), external_node_v8_namespaceObject = __turbopack_require__("[externals]/node:v8 [external] (node:v8, cjs)"), external_node_util_namespaceObject = __turbopack_require__("[externals]/node:util [external] (node:util, cjs)"), BUILTIN_MODULES = new Set(external_node_module_namespaceObject.builtinModules);
        ...
        const FILENAME_RE = /(^|[/\\])([^/\\]+?)(?=(\.[^.]+)?$)/;
        function utils_hasTrailingSlash(path = "/") {
            const lastChar = path[path.length - 1];
            return "/" === lastChar || "\\" === lastChar;
        }
        const package_namespaceObject = {
            rE: "2.4.2"
        }, external_node_crypto_namespaceObject = __turbopack_require__("[externals]/node:crypto [external] (node:crypto, cjs)"), dist_r = Object.create(null), dist_i = (e)=>globalThis.process?.env || globalThis.Deno?.env.toObject() || globalThis.__env__ || (e ? dist_r : globalThis), dist_s = new Proxy(dist_r, {
            get: (e, o)=>dist_i()[o] ?? dist_r[o],
            has: (e, o)=>o in dist_i() || o in dist_r,
            set: (e, o, E)=>(dist_i(!0)[o] = E, !0),
            deleteProperty (e, o) {
                if (!o) return !1;
                return delete dist_i(!0)[o], !0;
            },
            ownKeys () {
                const e = dist_i(!0);
                return Object.keys(e);
            }
        }), dist_t = typeof process < "u" && process.env && process.env.NODE_ENV || "", B = [
            [
                "APPVEYOR"
            ],
            [
        ...
        const external_node_tty_namespaceObject = __turbopack_require__("[externals]/node:tty [external] (node:tty, cjs)"), hasColors = external_node_tty_namespaceObject?.WriteStream?.prototype?.hasColors?.() ?? !1, base_format = (open, close)=>{
        ...
        function debug(ctx, ...args) {
            ...
            console.log(gray([
                "[jiti]",
                ...args.map((arg)=>arg in debugMap ? debugMap[arg] : "string" != typeof arg ? JSON.stringify(arg) : arg.replace(cwd, "."))
            ].join(" ")));
        }
        function jitiInteropDefault(ctx, mod) {
            return ctx.opts.interopDefault ? function(mod) {
                const modType = typeof mod;
                if (null === mod || "object" !== modType && "function" !== modType) return mod;
                const def = mod.default, defType = typeof def;
                if (null == def) return mod;
        ...
        function jitiResolve(ctx, id, options) {
            ...
            ctx.alias && (id = function(path, aliases) {
                ...
                for (const [alias, to] of Object.entries(aliases)){
                    ...
                    if (utils_hasTrailingSlash(_path[_alias.length])) return join(to, _path.slice(alias.length));
                }
                return _path;
            }(id, ctx.alias));
        ...
        function tryNativeRequireResolve(ctx, id, parentURL, options) {
            try {
                return ctx.nativeRequire.resolve(id, {
                    ...options,
                    paths: [
                        pathe_ff20891b_dirname(fileURLToPath(parentURL)),
                        ...options?.paths || []
                    ]
                });
            } catch  {}
        }
        const external_node_perf_hooks_namespaceObject = __turbopack_require__("[externals]/node:perf_hooks [external] (node:perf_hooks, cjs)"), external_node_vm_namespaceObject = __turbopack_require__("[externals]/node:vm [external] (node:vm, cjs)");
        ...
        function jitiRequire(ctx, id, opts) {
            ...
            if (id.startsWith("node:")) id = id.slice(5);
                ...
                return debug(ctx, "[native]", "[data]", "[import]", id), nativeImportOrRequire(ctx, id, !0);
            }
            ...
            if (ctx.opts.tryNative && !ctx.opts.transformOptions) try {
                ...
                if (debug(ctx, "[try-native]", opts.async && ctx.nativeImport ? "[import]" : "[require]", id), opts.async && ctx.nativeImport) return ctx.nativeImport(id).then((m)=>(!1 === ctx.opts.moduleCache && delete ctx.nativeRequire.cache[id], jitiInteropDefault(ctx, m)));
                {
            ...
            if (cache[filename]) return jitiInteropDefault(ctx, cache[filename]?.exports);
        ...
        function nativeImportOrRequire(ctx, id, async) {
            return async && ctx.nativeImport ? ctx.nativeImport(function(id) {
                return _ && isAbsolute(id) ? pathToFileURL(id) : id;
        ...
        function getCache(ctx, topts, get) {
            ...
            let cacheName = `${basename(pathe_ff20891b_dirname(topts.filename))}-${function(path) {
        ...
        function prepareCacheDir(ctx) {
            if (!0 === ctx.opts.fsCache && (ctx.opts.fsCache = function(ctx) {
                const nmDir = ctx.filename && resolve(ctx.filename, "../node_modules");
                if (nmDir && (0, external_node_fs_namespaceObject.existsSync)(nmDir)) return join(nmDir, ".cache/jiti");
                ...
                if ((0, external_node_fs_namespaceObject.mkdirSync)(ctx.opts.fsCache, {
                    recursive: !0
                }), !function(filename) {
                    try {
                ...
                debug(ctx, "Error creating cache directory at ", ctx.opts.fsCache, error), ctx.opts.fsCache = !1;
            }
        }
        ...
        function eval_evalModule(ctx, source, evalOptions = {}) {
            const id = evalOptions.id || (evalOptions.filename ? basename(evalOptions.filename) : `_jitiEval.${evalOptions.ext || (evalOptions.async ? "mjs" : "js")}`), filename = evalOptions.filename || jitiResolve(ctx, id, {
                async: evalOptions.async
            }), ext = evalOptions.ext || extname(filename), cache = evalOptions.cache || ctx.parentCache || {}, isTypescript = /\.[cm]?tsx?$/.test(ext), isESM = ".mjs" === ext || ".js" === ext && "module" === function(path) {
                for(; path && "." !== path && "/" !== path;){
                    path = join(path, "..");
                    try {
                        const pkg = (0, external_node_fs_namespaceObject.readFileSync)(join(path, "package.json"), "utf8");
                        try {
            ...
            if (needsTranspile) {
                ...
                if (debug(ctx, "[native]", evalOptions.async ? "[import]" : "[require]", filename), evalOptions.async) return Promise.resolve(nativeImportOrRequire(ctx, filename, evalOptions.async)).catch((error)=>(debug(ctx, "Native import error:", error), debug(ctx, "[fallback]", filename), eval_evalModule(ctx, source, {
                        ...evalOptions,
                        forceTranspile: !0
                    })));
                try {
                    ...
                    debug(ctx, "Native require error:", error), debug(ctx, "[fallback]", filename), source = transform(ctx, {
                        filename,
                        source,
                        ts: isTypescript,
                        async: evalOptions.async ?? !1,
            ...
            let compiled;
            mod.require = _jiti, mod.path = pathe_ff20891b_dirname(filename), mod.paths = external_node_module_namespaceObject.Module._nodeModulePaths(mod.path), cache[filename] = mod, ctx.opts.moduleCache && (ctx.nativeRequire.cache[filename] = mod);
            const wrapped = function(source, opts) {
            ...
            try {
                ...
                "SyntaxError" === error.name && evalOptions.async && ctx.nativeImport ? (debug(ctx, "[esm]", "[import]", "[fallback]", filename), compiled = function(code, nativeImport) {
                    ...
                    return (...args)=>nativeImport(uri).then((mod)=>mod.default(...args));
        ...
        function createJiti(filename, userOptions = {}, parentContext, isNested = !1) {
            const opts = isNested ? userOptions : function(userOptions) {
                const jitiDefaults = {
                ...
                return void 0 !== userOptions.cache && (deprecatOverrides.fsCache = userOptions.cache), void 0 !== userOptions.requireCache && (deprecatOverrides.moduleCache = userOptions.requireCache), {
                    ...jitiDefaults,
                    ...deprecatOverrides,
                    ...userOptions
                };
                ...
                "jiti",
                ...opts.nativeModules || []
            ], isNativeRe = new RegExp(`node_modules/(${nativeModules.map((m)=>escapeStringRegexp(m)).join("|")})/`), transformModules = [
            ...
            const url = pathToFileURL(filename), additionalExts = [
                ...opts.extensions
            ].filter((ext)=>".js" !== ext), nativeRequire = parentContext.createRequire(("TURBOPACK compile-time truthy", 1) ? filename.replace(/\//g, "\\") : ("TURBOPACK unreachable", undefined)), ctx = {
                filename,
                url,
                opts,
                alias,
            ...
            const jiti = Object.assign(function(id) {
                ...
                options: opts,
                resolve: Object.assign(function(path) {
...
//# sourceMappingURL=e49d7_jiti_dist_jiti_cjs_815929._.js.map