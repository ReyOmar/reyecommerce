...
"[project]/node_modules/enhanced-resolve/lib/getPaths.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/CloneBasenamePlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
/*
	...
	Author Tobias Koppers @sokra
*/ "use strict";
const basename = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/getPaths.js [postcss] (ecmascript)").basename;
...
"[project]/node_modules/enhanced-resolve/lib/LogInfoPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/forEachBail.js [postcss] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ module.exports = function forEachBail(array, iterator, callback) {
    ...
    let i = 0;
    const next = ()=>{
        /** @type {boolean|undefined} */ let loop = undefined;
...
"[project]/node_modules/enhanced-resolve/lib/CachedInputFileSystem.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
/*
	...
	Author Tobias Koppers @sokra
*/ "use strict";
const nextTick = __turbopack_require__("[externals]/process [external] (process, cjs)").nextTick;
	 ...
	 */ constructor(provider, syncProvider, providerContext){
        ...
        this.provide = this._provider ? /**
            ...
            if (typeof path !== "string" && !Buffer.isBuffer(path) && !(path instanceof URL) && typeof path !== "number") {
                /** @type {Function} */ callback(new TypeError("path must be a string, Buffer, URL or number"));
                return;
            }
            if (options) {
 ...
 */ class CacheBackend {
	 ...
	 */ constructor(duration, provider, syncProvider, providerContext){
        ...
        this._syncProvider = syncProvider;
        this._providerContext = providerContext;
        /** @type {Map<string, FileSystemCallback<any>[]>} */ this._activeAsyncOperations = new Map();
        /** @type {Map<string, { err: Error | null, result?: any, level: Set<string> }>} */ this._data = new Map();
	 ...
	 */ provide(path, options, callback) {
        ...
        // Run the operation
        /** @type {Function} */ this._provider.call(this._providerContext, path, /**
			 * @param {Error | null} err error
			 * @param {any} [result] result
			 */ (err, result)=>{
    ...
    _enterAsyncMode() {
        ...
        switch(this._mode){
            ...
            case STORAGE_MODE_SYNC:
                ...
                if (/** @type {STORAGE_MODE_IDLE | STORAGE_MODE_SYNC | STORAGE_MODE_ASYNC}*/ this._mode === STORAGE_MODE_IDLE) return;
...
"[project]/node_modules/enhanced-resolve/lib/createInnerContext.js [postcss] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ module.exports = function createInnerContext(options, message) {
    ...
    if (options.log) {
        if (message) {
			 ...
			 */ innerLog = (msg)=>{
                if (!messageReported) {
                    /** @type {(function(string): void)} */ options.log(message);
                    messageReported = true;
                }
                /** @type {(function(string): void)} */ options.log("  " + msg);
            };
        } else {
...
"[project]/node_modules/enhanced-resolve/lib/util/identifier.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/util/path.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/Resolver.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
/*
	...
	Author Tobias Koppers @sokra
*/ "use strict";
const { AsyncSeriesBailHook, AsyncSeriesHook, SyncHook } = __turbopack_require__("[project]/node_modules/tapable/lib/index.js [postcss] (ecmascript)");
const createInnerContext = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/createInnerContext.js [postcss] (ecmascript)");
const { parseIdentifier } = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/util/identifier.js [postcss] (ecmascript)");
const { normalize, cachedJoin: join, getType, PathType } = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/util/path.js [postcss] (ecmascript)");
 ...
 */ /** @typedef {string | number | boolean | null} JsonPrimitive */ /** @typedef {JsonValue[]} JsonArray */ /** @typedef {JsonPrimitive | JsonObject | JsonArray} JsonValue */ /** @typedef {{[Key in string]: JsonValue} & {[Key in string]?: JsonValue | undefined}} JsonObject */ /**
...
class Resolver {
	 ...
	 */ resolveSync(context, path, request) {
        /** @type {Error | null | undefined} */ let err = undefined;
        /** @type {string | false | undefined} */ let result = undefined;
        let sync = false;
...
"[project]/node_modules/enhanced-resolve/lib/SyncAsyncFileSystemDecorator.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
/*
	...
	Author Tobias Koppers @sokra
*/ "use strict";
/** @typedef {import("./Resolver").FileSystem} FileSystem */ /** @typedef {import("./Resolver").ReaddirStringCallback} ReaddirStringCallback */ /** @typedef {import("./Resolver").StringCallback} StringCallback */ /** @typedef {import("./Resolver").SyncFileSystem} SyncFileSystem */ /**
 ...
 */ function SyncAsyncFileSystemDecorator(fs) {
    ...
    if (lstatSync) {
        this.lstat = (arg, options, callback)=>{
            let result;
            try {
                result = /** @type {Function | undefined} */ callback ? lstatSync.call(fs, arg, options) : lstatSync.call(fs, arg);
            } catch (e) {
    ...
    this.stat = (arg, options, callback)=>{
        let result;
        try {
            result = /** @type {Function | undefined} */ callback ? fs.statSync(arg, options) : fs.statSync(arg);
        } catch (e) {
            return (callback || options)(e);
        }
        (callback || options)(null, result);
    ...
    this.readdir = (arg, options, callback)=>{
        let result;
        try {
            result = /** @type {Function | undefined} */ callback ? fs.readdirSync(arg, options) : fs.readdirSync(arg);
        } catch (e) {
            return (callback || options)(e);
        }
        (callback || options)(null, result);
    ...
    this.readFile = (arg, options, callback)=>{
        let result;
        try {
            result = /** @type {Function | undefined} */ callback ? fs.readFileSync(arg, options) : fs.readFileSync(arg);
        } catch (e) {
            return (callback || options)(e);
        }
        (callback || options)(null, result);
    ...
    this.readlink = (arg, options, callback)=>{
        let result;
        try {
            result = /** @type {Function | undefined} */ callback ? fs.readlinkSync(arg, options) : fs.readlinkSync(arg);
        } catch (e) {
            return (callback || options)(e);
        }
        (callback || options)(null, result);
    ...
    if (realpathSync) {
        this.realpath = (arg, options, callback)=>{
            let result;
            try {
                result = /** @type {Function | undefined} */ callback ? realpathSync.call(fs, arg, options) : realpathSync.call(fs, arg);
            } catch (e) {
                return (callback || options)(e);
            }
            (callback || options)(null, result);
...
"[project]/node_modules/enhanced-resolve/lib/DescriptionFileUtils.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
/*
	...
	Author Tobias Koppers @sokra
*/ "use strict";
const forEachBail = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/forEachBail.js [postcss] (ecmascript)");
...
"[project]/node_modules/enhanced-resolve/lib/getInnerRequest.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/AliasFieldPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
/*
	...
	Author Tobias Koppers @sokra
*/ "use strict";
const DescriptionFileUtils = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/DescriptionFileUtils.js [postcss] (ecmascript)");
const getInnerRequest = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/getInnerRequest.js [postcss] (ecmascript)");
...
"[project]/node_modules/enhanced-resolve/lib/AliasPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
*/ "use strict";
const forEachBail = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/forEachBail.js [postcss] (ecmascript)");
const { PathType, getType } = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/util/path.js [postcss] (ecmascript)");
...
"[project]/node_modules/enhanced-resolve/lib/AppendPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/ConditionalPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/DescriptionFilePlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/DirectoryExistsPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/util/entrypoints.js [postcss] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ function conditionalMapping(conditionalMapping_, conditionNames) {
    /** @type {[ConditionalMapping, string[], number][]} */ let lookup = [
        [
            conditionalMapping_,
...
"[project]/node_modules/enhanced-resolve/lib/ExportsFieldPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
const DescriptionFileUtils = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/DescriptionFileUtils.js [postcss] (ecmascript)");
const forEachBail = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/forEachBail.js [postcss] (ecmascript)");
const { processExportsField } = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/util/entrypoints.js [postcss] (ecmascript)");
const { parseIdentifier } = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/util/identifier.js [postcss] (ecmascript)");
const { invalidSegmentRegEx, deprecatedInvalidSegmentRegEx } = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/util/path.js [postcss] (ecmascript)");
        ...
        resolver.getHook(this.source).tapAsync("ExportsFieldPlugin", (request, resolveContext, callback)=>{
            ...
            forEachBail(paths, /**
                ...
                if (relativePath.length === 0 || !relativePath.startsWith("./")) {
                    if (paths.length === i) {
                        return callback(new Error(`Invalid "exports" target "${p}" defined for "${usedField}" in the package config ${request.descriptionFilePath}, targets must start with "./"`));
                    }
                    return callback();
                }
...
"[project]/node_modules/enhanced-resolve/lib/ExtensionAliasPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/FileExistsPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/ImportsFieldPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
const DescriptionFileUtils = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/DescriptionFileUtils.js [postcss] (ecmascript)");
const forEachBail = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/forEachBail.js [postcss] (ecmascript)");
const { processImportsField } = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/util/entrypoints.js [postcss] (ecmascript)");
const { parseIdentifier } = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/util/identifier.js [postcss] (ecmascript)");
const { invalidSegmentRegEx, deprecatedInvalidSegmentRegEx } = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/util/path.js [postcss] (ecmascript)");
                    ...
                    case dotCode:
                        {
                            if (invalidSegmentRegEx.exec(path_.slice(2)) !== null && deprecatedInvalidSegmentRegEx.test(path_.slice(2)) !== null) {
                                if (paths.length === i) {
                                    return callback(new Error(`Invalid "imports" target "${p}" defined for "${usedField}" in the package config ${request.descriptionFilePath}, targets must start with "./"`));
                                }
                                return callback();
                            }
                            /** @type {ResolveRequest} */ const obj = {
...
"[project]/node_modules/enhanced-resolve/lib/JoinRequestPartPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/JoinRequestPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/MainFieldPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
module.exports = class MainFieldPlugin {
	 ...
	 */ apply(resolver) {
        ...
        resolver.getHook(this.source).tapAsync("MainFieldPlugin", (request, resolveContext, callback)=>{
            if (request.path !== request.descriptionFileRoot || /** @type {ResolveRequest & { [alreadyTriedMainField]?: string }} */ request[alreadyTriedMainField] === request.descriptionFilePath || !request.descriptionFilePath) return callback();
...
"[project]/node_modules/enhanced-resolve/lib/ModulesInHierarchicalDirectoriesPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
*/ "use strict";
const forEachBail = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/forEachBail.js [postcss] (ecmascript)");
const getPaths = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/getPaths.js [postcss] (ecmascript)");
...
"[project]/node_modules/enhanced-resolve/lib/ModulesInRootPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/NextPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/ParsePlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/PnpPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/RestrictionsPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/ResultPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/RootsPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/SelfReferencePlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/SymlinkPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
const forEachBail = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/forEachBail.js [postcss] (ecmascript)");
const getPaths = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/getPaths.js [postcss] (ecmascript)");
const { getType, PathType } = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/util/path.js [postcss] (ecmascript)");
...
"[project]/node_modules/enhanced-resolve/lib/TryNextPlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/UnsafeCachePlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
/*
	...
	Author Tobias Koppers @sokra
*/ "use strict";
/** @typedef {import("./Resolver")} Resolver */ /** @typedef {import("./Resolver").ResolveRequest} ResolveRequest */ /** @typedef {import("./Resolver").ResolveStepHook} ResolveStepHook */ /** @typedef {import("./Resolver").ResolveContextYield} ResolveContextYield */ /** @typedef {{[k: string]: ResolveRequest | ResolveRequest[] | undefined}} Cache */ /**
...
"[project]/node_modules/enhanced-resolve/lib/UseFilePlugin.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/enhanced-resolve/lib/ResolverFactory.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
/*
	...
	Author Tobias Koppers @sokra
*/ "use strict";
const versions = __turbopack_require__("[externals]/process [external] (process, cjs)").versions;
const Resolver = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/Resolver.js [postcss] (ecmascript)");
const { getType, PathType } = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/util/path.js [postcss] (ecmascript)");
const SyncAsyncFileSystemDecorator = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/SyncAsyncFileSystemDecorator.js [postcss] (ecmascript)");
const AliasFieldPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/AliasFieldPlugin.js [postcss] (ecmascript)");
const AliasPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/AliasPlugin.js [postcss] (ecmascript)");
const AppendPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/AppendPlugin.js [postcss] (ecmascript)");
const ConditionalPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/ConditionalPlugin.js [postcss] (ecmascript)");
const DescriptionFilePlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/DescriptionFilePlugin.js [postcss] (ecmascript)");
const DirectoryExistsPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/DirectoryExistsPlugin.js [postcss] (ecmascript)");
const ExportsFieldPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/ExportsFieldPlugin.js [postcss] (ecmascript)");
const ExtensionAliasPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/ExtensionAliasPlugin.js [postcss] (ecmascript)");
const FileExistsPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/FileExistsPlugin.js [postcss] (ecmascript)");
const ImportsFieldPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/ImportsFieldPlugin.js [postcss] (ecmascript)");
const JoinRequestPartPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/JoinRequestPartPlugin.js [postcss] (ecmascript)");
const JoinRequestPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/JoinRequestPlugin.js [postcss] (ecmascript)");
const MainFieldPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/MainFieldPlugin.js [postcss] (ecmascript)");
const ModulesInHierarchicalDirectoriesPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/ModulesInHierarchicalDirectoriesPlugin.js [postcss] (ecmascript)");
const ModulesInRootPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/ModulesInRootPlugin.js [postcss] (ecmascript)");
const NextPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/NextPlugin.js [postcss] (ecmascript)");
const ParsePlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/ParsePlugin.js [postcss] (ecmascript)");
const PnpPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/PnpPlugin.js [postcss] (ecmascript)");
const RestrictionsPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/RestrictionsPlugin.js [postcss] (ecmascript)");
const ResultPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/ResultPlugin.js [postcss] (ecmascript)");
const RootsPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/RootsPlugin.js [postcss] (ecmascript)");
const SelfReferencePlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/SelfReferencePlugin.js [postcss] (ecmascript)");
const SymlinkPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/SymlinkPlugin.js [postcss] (ecmascript)");
const TryNextPlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/TryNextPlugin.js [postcss] (ecmascript)");
const UnsafeCachePlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/UnsafeCachePlugin.js [postcss] (ecmascript)");
const UseFilePlugin = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/UseFilePlugin.js [postcss] (ecmascript)");
/** @typedef {import("./AliasPlugin").AliasOption} AliasOptionEntry */ /** @typedef {import("./ExtensionAliasPlugin").ExtensionAliasOption} ExtensionAliasOption */ /** @typedef {import("./PnpPlugin").PnpApiImpl} PnpApi */ /** @typedef {import("./Resolver").EnsuredHooks} EnsuredHooks */ /** @typedef {import("./Resolver").FileSystem} FileSystem */ /** @typedef {import("./Resolver").KnownHooks} KnownHooks */ /** @typedef {import("./Resolver").ResolveRequest} ResolveRequest */ /** @typedef {import("./Resolver").SyncFileSystem} SyncFileSystem */ /** @typedef {string|string[]|false} AliasOptionNewRequest */ /** @typedef {{[k: string]: AliasOptionNewRequest}} AliasOptions */ /** @typedef {{[k: string]: string|string[] }} ExtensionAliasOptions */ /** @typedef {false | 0 | "" | null | undefined} Falsy */ /** @typedef {{apply: function(Resolver): void} | (function(this: Resolver, Resolver): void) | Falsy} Plugin */ /**
 ...
 */ function processPnpApiOption(option) {
    if (option === undefined && /** @type {NodeJS.ProcessVersions & {pnp: string}} */ versions.pnp) {
        const _findPnpApi = // @ts-ignore
        __turbopack_require__("[externals]/module [external] (module, cjs)").findPnpApi;
        if (_findPnpApi) {
            return {
 ...
 */ function createOptions(options) {
    ...
    return {
        ...
        descriptionFiles: Array.from(new Set(options.descriptionFiles || [
            "package.json"
        ])),
 ...
 */ exports.createResolver = function(options) {
    ...
    const resolved = /** @type {KnownHooks & EnsuredHooks} */ resolver.hooks.resolved;
    // resolved
    ...
    for (const plugin of plugins){
        if (typeof plugin === "function") {
            /** @type {function(this: Resolver, Resolver): void} */ plugin.call(resolver, resolver);
        } else if (plugin) {
...
"[project]/node_modules/enhanced-resolve/lib/index.js [postcss] (ecmascript)": (function(__turbopack_context__) {
...
/*
	...
	Author Tobias Koppers @sokra
*/ "use strict";
const fs = __turbopack_require__("[project]/node_modules/graceful-fs/graceful-fs.js [postcss] (ecmascript)");
const CachedInputFileSystem = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/CachedInputFileSystem.js [postcss] (ecmascript)");
const ResolverFactory = __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/ResolverFactory.js [postcss] (ecmascript)");
/** @typedef {import("./PnpPlugin").PnpApiImpl} PnpApi */ /** @typedef {import("./Resolver")} Resolver */ /** @typedef {import("./Resolver").FileSystem} FileSystem */ /** @typedef {import("./Resolver").ResolveCallback} ResolveCallback */ /** @typedef {import("./Resolver").ResolveContext} ResolveContext */ /** @typedef {import("./Resolver").ResolveRequest} ResolveRequest */ /** @typedef {import("./ResolverFactory").Plugin} Plugin */ /** @typedef {import("./ResolverFactory").UserResolveOptions} ResolveOptions */ /** @typedef {{
...
module.exports = mergeExports(resolve, {
    ...
    get CloneBasenamePlugin () {
        return __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/CloneBasenamePlugin.js [postcss] (ecmascript)");
    },
    get LogInfoPlugin () {
        return __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/LogInfoPlugin.js [postcss] (ecmascript)");
    },
    get forEachBail () {
        return __turbopack_require__("[project]/node_modules/enhanced-resolve/lib/forEachBail.js [postcss] (ecmascript)");
    }
});
}}),
...
//# sourceMappingURL=node_modules_enhanced-resolve_lib_1ca5ea._.js.map